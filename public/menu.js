function Menu(){
  ...
  this.items.push(new Button(-7.00,  4,     13.75, 7,  1, "Contribute"))
  this.items.push(new Button(-7.00,  11.25, 13.75, 7,  1, "Profile"))
  this.items.push(new Button( 7.00,  4,     13.75, 7,  1, "Store"))
  this.items.push(new Button( 7.00,  11.25, 13.75, 7,  1, "Leaderboard"))
